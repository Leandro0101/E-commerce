...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body>
    ...
    <div class="bg-dark">
      <div class="container">
        <img src="{{asset('assets/img/templete.webp')}}">
      </div> 
    </div>    
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="main_nav">
          <div class="offcanvas-header mt-3">  
            {{-- <button class="btn btn-lg btn-close btn btn-outline-dark float-right"><i class="fas fa-times"></i></button> --}}
          ...
          <ul class="navbar-nav ml-5">
            ...
            <li class="nav-item dropdown has-megamenu">
              ...
              <h6 ><strong><a class="ml-4" style="text-decoration: none;color:black;" href="{{ route('mais_vendidos') }}">Lançamentos</a></strong></h6>
              </div>
              </li>
          ...
          {{-- Se houver a sessão do carrinho, ou seja, houver algum item no carrinho, o contador de itens irá incrementar a quantidade de itens no carrinho --}}
            @if(session()->has('carrinho'))
              <a class="nav-link" href="{{ route('carrinho.carrinho') }}"><i class="fas fa-shopping-bag fa-2x"></i>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-map-marked-alt"></i><a href="{{ route('endereco.edit', ['endereco' => session()->get('cliente')] ) }}"> Meu endereço</a></i></h5>
            </div>
  ...
  <footer class="mt-5">
    ...
    <div class="col-md-3 col-xl-4 mx-auto mb-4">
      ...
      <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block" style="width: 60px;">
      <div class="row">
      {{-- ERRO DE VERIFICAÇÃO, QUANDO ESTÁ NA PÁGINA DO ADMIN, SEM CONDIÇÕES --}}
        {{-- @if($produto->fotos->count())
        <div class="col"><a href="#" class="nav-link"><img src="{{asset('storage/'.$produto->fotos->first()->path) }}" alt="" class="card-img-top"></a></div>
        <div class="col"><a href="#" class="nav-link"><img src="{{asset('storage/'.$produto->fotos->first()->path) }}" alt="" class="card-img-top"></a></div>
        <div class="col"><a href="#" class="nav-link"><img src="{{asset('storage/'.$produto->fotos->first()->path) }}" alt="" class="card-img-top"></a></div>
        <div class="w-100"></div>
        <div class="col"><a href="#" class="nav-link"><img src="{{asset('storage/'.$produto->fotos->first()->path) }}" alt="" class="card-img-top"></a></div>
        ...
        <div class="col"><a href="#" class="nav-link"><img src="{{asset('storage/'.$produto->fotos->first()->path) }}" alt="" class="card-img-top"></a></div>
        @else
          <img src="{{asset('storage/produtos/semfoto.png') }}" alt="" class="card-img-top">
        @endif --}}
      </div>
    </div>
      </div>
